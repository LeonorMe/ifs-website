      ...
      <article>
        ...
        <div className="container dual left">
          <div className="text_wrapper">
            <div>
              ...
              <p>
                A equipa conta atualmente com 3 carros: IFS01 (combustão), IFS02
                e IFS03 (elétricos). Estamos agora progredir no desenvolvimento
                de carros elétricos com o novo modelo, o IFS04, cujo objetivo é
                melhorar a performance obtida pelo nosso anterior carro.
              </p>
            </div>
          </div>
          <div className="image_wrapper">
        ...
        <div className="container">
          <div className="text_wrapper">
            ...
            <p>
              Na presente época, 2023-2024, a equipa começou a desenvolver o seu
              terceiro veículo elétrico, o IFS04, e irá novamente às competições
              FS Spain e FS Portugal, irá apresentar o IFS04 ao público com a
              realização de um rollout.
            </p>
          </div>
        </div>
      </article>
